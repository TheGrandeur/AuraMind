...
import PrimaryButton from "../components/PrimaryButton"; // ✅ import your reusable button
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl w-full">
        {[
          { title: "Multiple Difficulties", text: "Choose from Easy, Medium, or Hard questions to match your skill level", icon: <Brain className="w-6 h-6 text-green-600" />, bg: "bg-green-100" },
          { title: "Timed Challenges", text: "30-second timer per question keeps the excitement high", icon: <Zap className="w-6 h-6 text-purple-600" />, bg: "bg-purple-100" },
          { title: "Track Your Best", text: "Save your highest scores and see detailed results", icon: <Trophy className="w-6 h-6 text-yellow-600" />, bg: "bg-yellow-100" },
        ].map((card, idx) => (
          <motion.div
            key={idx}
            custom={idx}
